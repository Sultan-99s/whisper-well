...
SCHEMA_PATH = Path('/home/bdcalling/Code/whisper-well-being-oasis-main/Backend/app/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-3.0.x': '/home/bdcalling/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    slot: 'actions.SlotActions[models.Slot]'
    booking: 'actions.BookingActions[models.Booking]'
    urgentrequest: 'actions.UrgentRequestActions[models.UrgentRequest]'
    ...
    def __init__(
        ...
        *,
        ...
        self.slot = actions.SlotActions[models.Slot](self, models.Slot)
        self.booking = actions.BookingActions[models.Booking](self, models.Booking)
        self.urgentrequest = actions.UrgentRequestActions[models.UrgentRequest](self, models.UrgentRequest)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/home/bdcalling/Code/whisper-well-being-oasis-main/Backend/app/prisma/schema.prisma',
        }
...
class Batch:
    slot: 'SlotBatchActions'
    booking: 'BookingBatchActions'
    urgentrequest: 'UrgentRequestBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.slot = SlotBatchActions(self)
        self.booking = BookingBatchActions(self)
        self.urgentrequest = UrgentRequestBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class UrgentRequestBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
